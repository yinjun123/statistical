...
def us_info():
    ...
    sql = "SELECT distinct user_id FROM t_order_info WHERE TO_DAYS(NOW()) - TO_DAYS(gmt_modify) <= 1"#查询当天的订单并对user_id去重
        ...
        # 有数据
            ...
            for i in sj:
                ...
                # 如果成功申请是老顾客,取出最后一条数据
                    ...
                    sql = "select borrowing_amount,rec_date,reim_date,timeout_day from t_order_info where id = '%s' " % \
                          s['order_id']
